...
test("Pi entry point reuses upstream extension once and owns only four non-conflicting tools",()=>{
...
test("reused Ai4Scholar search is callable through pi-scholar without a copied client",async t=>{
